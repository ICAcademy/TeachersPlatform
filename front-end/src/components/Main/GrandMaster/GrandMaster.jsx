        ...
        <div className={styles.grandMasterContainer}>
          ...
          <div className={styles.infoContainer}>
            <p className={styles.info}>
              ...
              civilization. Education is necessary to understand the universe around us and convert
              it into something more beneficial. With the help of knowledge, we can develop a new
              perspective for our life.
            </p>
          </div>
