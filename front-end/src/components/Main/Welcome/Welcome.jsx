            ...
            <div className={styles.content}>
                <div className={styles.welcomeInfo}>
                    ...
                    <div className={styles.titleContainer}>
                        <h1 className={styles.title}>Welcome to the <span className={styles.future}>future</span> educations systems</h1>
                    </div>
                    <div>
                        <p className={styles.info}>
                            We see a multitude of talents in every child with
                            parents to discover, nurture and celebrate each
